...
public class Jeu {
    ...
    public boolean equals(Object o) {
        ...
        Jeu jeu = (Jeu) o;
        return no_jeu == jeu.no_jeu && reference == jeu.reference && tarif_journée == jeu.tarif_journée && age_mini == jeu.age_mini && duree == jeu.duree && Objects.equals(titre, jeu.titre) && Objects.equals(description, jeu.description) && Objects.equals(genres, jeu.genres);
    }

    @Override
    public int hashCode() {
        return Objects.hash(no_jeu, titre, reference, description, tarif_journée, age_mini, duree, genres);
    }
}
